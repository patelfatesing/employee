...
@section('content')
    ...
    <section class="section dashboard">
        <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Create Employee Form</h5>

                    <!-- General Form Elements -->
                    <form action="{{ url('employees/store') }}" enctype="multipart/form-data" method="POST">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-2">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" aria-label="Default select example" id="country_code"
                                        ...
                                        <option value="2" {{ old('country_code') == '2' ? 'selected' : '' }}>+2
                                        </option>
                                        <option value="3" {{ old('country_code') == '3' ? 'selected' : '' }}>+3
                                        </option>
                                        <option value="91" {{ old('country_code') == '91' ? 'selected' : '' }}>+91
                                        </option>
                                        <option value="92" {{ old('country_code') == '92' ? 'selected' : '' }}>+92
                                        </option>
                                        <option value="95" {{ old('country_code') == '95' ? 'selected' : '' }}>+95
                                        </option>
                                        <option value="100" {{ old('country_code') == '100' ? 'selected' : '' }}>
                                            +100</option>
                                    </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-6">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" style="height: 100px" name="address" id="address">{{ old('description') }}</textarea>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="gender" id="gridRadios1"
                                                {{ old('gender') == 'male' ? 'checked' : '' }} value="male" checked>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="gender"
                                                {{ old('gender') == 'male' ? 'checked' : '' }} id="gridRadios2"
                                                value="female">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="gridCheck1" name="hobby[]"
                                            value="cricket" {{ in_array('cricket', old('hobby', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="gridCheck2" name="hobby[]"
                                            value="travaling"
                                            {{ in_array('travaling', old('hobby', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="gridCheck3" name="hobby[]"
                                            value="reading" {{ in_array('reading', old('hobby', [])) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="gridCheck4" name="hobby[]"
                                            value="music" {{ in_array('music', old('hobby', [])) ? 'checked' : '' }}>
